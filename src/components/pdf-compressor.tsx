  ...
  const compressPDFs = async () => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      const compressedUrl = URL.createObjectURL(
        new Blob([new ArrayBuffer(compressedSize)], { type: "application/pdf" }),
      )
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="text-center">
              <p className="font-medium">Drag & drop PDF files here, or click to select files</p>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="flex gap-3">
                ...
                {allCompleted ? (
                  ...
                  <Button size="sm" onClick={compressPDFs} disabled={isCompressing || files.length === 0}>
                ...
                <Card key={file.id} className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-2">
                      ...
                      {file.status === "error" && (
                        <p className="text-xs text-destructive">{file.error || "Error compressing PDF"}</p>
                      )}
                    </div>
                  </CardContent>
                </Card>
      ...
      <TabsContent value="settings" className="space-y-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Adjust these settings to control the compression quality and output options.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="quality">Overall Quality ({quality}%)</Label>
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">
                        Controls the overall compression level. Lower quality means smaller file size but may affect
                        readability.
                      </p>
                    </TooltipContent>
                  </Tooltip>
              ...
              />
              <p className="text-xs text-muted-foreground">Recommended: 60-80% for web sharing, 80-100% for printing</p>
            </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">
                        Controls the quality of images embedded in the PDF. Lower quality means smaller file size.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
            ...
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                <Label htmlFor="optimize-fonts">Optimize Fonts</Label>
                <p className="text-xs text-muted-foreground">Subset and compress fonts to reduce file size</p>
              </div>
              <Switch id="optimize-fonts" checked={optimizeFonts} onCheckedChange={setOptimizeFonts} />
            </div>
          </CardContent>
          <CardFooter>
            <p className="text-xs text-muted-foreground">Settings are applied to all PDFs in the current session</p>
          </CardFooter>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              These settings are for users who need more control over the PDF compression process.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Convert interactive form fields to static content</p>
              </div>
            ...
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Remove comments, form fields, and other annotations</p>
              </div>
              <Switch defaultChecked={false} />
            </div>
            ...
            <div className="flex items-center justify-between space-x-2">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Convert colored elements to grayscale to reduce file size
                </p>
              </div>
              <Switch defaultChecked={false} />
            </div>
